  ...
  "node_modules/vscode-languageserver-types/lib/umd/main.js"(exports2, module2) {
    (function(factory) {
      ...
      (function(Location3) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.objectLiteral(candidate) && Range.is(candidate.range) && (Is3.string(candidate.uri) || Is3.undefined(candidate.uri));
        }
        Location3.is = is;
      ...
      (function(LocationLink2) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.objectLiteral(candidate) && Range.is(candidate.targetRange) && Is3.string(candidate.targetUri) && Range.is(candidate.targetSelectionRange) && (Range.is(candidate.originSelectionRange) || Is3.undefined(candidate.originSelectionRange));
        }
        LocationLink2.is = is;
      ...
      (function(ColorInformation2) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.objectLiteral(candidate) && Range.is(candidate.range) && Color.is(candidate.color);
        }
      ...
      (function(TextEdit2) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.objectLiteral(candidate) && Is3.string(candidate.newText) && Range.is(candidate.range);
        }
        TextEdit2.is = is;
      ...
      (function(InsertReplaceEdit2) {
        ...
        function is(value) {
          var candidate = value;
          return candidate && Is3.string(candidate.newText) && Range.is(candidate.insert) && Range.is(candidate.replace);
        }
      ...
      (function(Hover2) {
        function is(value) {
          var candidate = value;
          return !!candidate && Is3.objectLiteral(candidate) && (MarkupContent.is(candidate.contents) || MarkedString.is(candidate.contents) || Is3.typedArray(candidate.contents, MarkedString.is)) && (value.range === void 0 || Range.is(value.range));
        }
        Hover2.is = is;
      ...
      (function(DocumentSymbol2) {
        ...
        function is(value) {
          var candidate = value;
          return candidate && Is3.string(candidate.name) && Is3.number(candidate.kind) && Range.is(candidate.range) && Range.is(candidate.selectionRange) && (candidate.detail === void 0 || Is3.string(candidate.detail)) && (candidate.deprecated === void 0 || Is3.boolean(candidate.deprecated)) && (candidate.children === void 0 || Array.isArray(candidate.children)) && (candidate.tags === void 0 || Array.isArray(candidate.tags));
        }
      ...
      (function(CodeLens2) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.defined(candidate) && Range.is(candidate.range) && (Is3.undefined(candidate.command) || Command2.is(candidate.command));
        }
        CodeLens2.is = is;
      ...
      (function(DocumentLink2) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.defined(candidate) && Range.is(candidate.range) && (Is3.undefined(candidate.target) || Is3.string(candidate.target));
        }
        DocumentLink2.is = is;
      ...
      (function(SelectionRange2) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.objectLiteral(candidate) && Range.is(candidate.range) && (candidate.parent === void 0 || SelectionRange2.is(candidate.parent));
        }
      ...
      (function(InlineValueText2) {
        ...
        function is(value) {
          var candidate = value;
          return candidate !== void 0 && candidate !== null && Range.is(candidate.range) && Is3.string(candidate.text);
        }
      ...
      (function(InlineValueVariableLookup2) {
        ...
        function is(value) {
          var candidate = value;
          return candidate !== void 0 && candidate !== null && Range.is(candidate.range) && Is3.boolean(candidate.caseSensitiveLookup) && (Is3.string(candidate.variableName) || candidate.variableName === void 0);
        }
      ...
      (function(InlineValueEvaluatableExpression2) {
        ...
        function is(value) {
          var candidate = value;
          return candidate !== void 0 && candidate !== null && Range.is(candidate.range) && (Is3.string(candidate.expression) || candidate.expression === void 0);
        }
      ...
      (function(InlineValueContext2) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.defined(candidate) && Range.is(value.stoppedLocation);
        }
      ...
      (function(InlayHintLabelPart2) {
        ...
        function is(value) {
          var candidate = value;
          return Is3.objectLiteral(candidate) && (candidate.tooltip === void 0 || Is3.string(candidate.tooltip) || MarkupContent.is(candidate.tooltip)) && (candidate.location === void 0 || Location2.is(candidate.location)) && (candidate.command === void 0 || Command2.is(candidate.command));
        }
...
async function findEslint(rootPath) {
  ...
  if (platform === "win32" && await fileExists(import_path.default.join(rootPath, "node_modules", ".bin", "eslint.cmd"))) {
    return import_path.default.join(".", "node_modules", ".bin", "eslint.cmd");
  } else if ((platform === "linux" || platform === "darwin") && await fileExists(import_path.default.join(rootPath, "node_modules", ".bin", "eslint"))) {
...
var EslintTask = class _EslintTask {
  constructor() {
    this.disposables = [];
    ...
    this.disposables.push(import_coc.commands.registerCommand(_EslintTask.id, async () => {
      ...
      cwd = await import_coc.workspace.nvim.call("getcwd");
    ...
    task.onExit((code) => {
      if (code != 0) {
        import_coc.window.showWarningMessage(`Eslint found issues: ${lastline}`);
      }
      this.onStop();
    });
    task.onStdout((lines) => {
    ...
    task.onStderr((lines) => {
      import_coc.window.showErrorMessage(`Eslint error: ` + lines.join("\n"));
    });
  ...
  onLine(line, cwd) {
    ...
    let filepath = cwd ? import_path2.default.relative(cwd, fullpath) : fullpath;
    let doc = import_coc.workspace.getDocument(uri);
    let bufnr = doc ? doc.bufnr : null;
    let cols = import_coc.workspace.env.columns - filepath.length;
    ...
    import_coc.workspace.nvim.call("setqflist", [[item], "a"], true);
  }
  async getOptions() {
    let folders = import_coc.workspace.workspaceFolders;
    if (folders.length === 0) return;
    let root = import_coc.Uri.parse(folders[0].uri).fsPath;
    let cmd = await findEslint(root);
    let config = import_coc.workspace.getConfiguration("eslint", folders[0]);
...
function toOSPath(path6) {
  if (process.platform === "win32") {
    path6 = path6.replace(/^\/(\w)\//, "$1:\\");
    return path6.replace(/\//g, "\\");
  } else {
    return path6;
  }
}
function toPosixPath(path6) {
  if (process.platform !== "win32") {
    return path6;
  }
  return path6.replace(/\\/g, "/");
}
async function findEslint2(rootPath) {
  const platform = process.platform;
  if (platform === "win32" && await existFile(import_path3.default.join(rootPath, "node_modules", ".bin", "eslint.cmd"))) {
    return import_path3.default.join(".", "node_modules", ".bin", "eslint.cmd");
  } else if ((platform === "linux" || platform === "darwin") && await existFile(import_path3.default.join(rootPath, "node_modules", ".bin", "eslint"))) {
    return import_path3.default.join(".", "node_modules", ".bin", "eslint");
  } else {
    return "eslint";
  }
}
function existFile(file) {
  return new Promise((resolve, _reject) => {
    import_fs2.default.stat(file, (error, stats) => {
      if (error !== null) {
        resolve(false);
      } else {
        resolve(stats.isFile());
...
((MigrationData2) => {
  function create(inspect) {
    return inspect === void 0 ? {
      global: { value: void 0, changed: false },
      workspace: { value: void 0, changed: false },
      workspaceFolder: { value: void 0, changed: false }
    } : {
  ...
  MigrationData2.create = create;
  function needsUpdate(data) {
    return data.global.changed || data.workspace.changed || data.workspaceFolder.changed;
  }
  MigrationData2.needsUpdate = needsUpdate;
})(MigrationData || (MigrationData = {}));
var Migration = class {
  constructor(resource) {
    this.workspaceConfig = import_coc3.workspace.getConfiguration(void 0, resource);
    this.eslintConfig = import_coc3.workspace.getConfiguration("eslint", resource);
    this.editorConfig = import_coc3.workspace.getConfiguration("editor", resource);
    this.codeActionOnSave = MigrationData.create(this.editorConfig.inspect("codeActionsOnSave"));
    this.autoFixOnSave = MigrationData.create(this.eslintConfig.inspect("autoFixOnSave"));
    this.validate = MigrationData.create(this.eslintConfig.inspect("validate"));
    this.workingDirectories = MigrationData.create(this.eslintConfig.inspect("workingDirectories"));
    this.languageSpecificSettings = /* @__PURE__ */ new Map();
  }
  record() {
  ...
  captureDidChangeSetting(func) {
    this.didChangeConfiguration = func;
  }
  recordAutoFixOnSave() {
    function record(elem, setting) {
      if (CodeActionsOnSave.isExplicitlyDisabled(setting.value)) {
        return false;
      }
      if (!Is2.objectLiteral(setting.value) && !Array.isArray(setting.value)) {
        setting.value = /* @__PURE__ */ Object.create(null);
      }
      const autoFix = !!elem.value;
      const sourceFixAll = !!CodeActionsOnSave.getSourceFixAll(setting.value);
      let result;
      if (autoFix !== sourceFixAll && autoFix && CodeActionsOnSave.getSourceFixAllESLint(setting.value) === void 0) {
  ...
  recordValidate(fixAll) {
    function record(elem, settingAccessor, fixAll2) {
      ...
      for (let i = 0; i < elem.value.length; i++) {
        ...
        if (fixAll2 && item.autoFix === false && typeof item.language === "string") {
    ...
    function getCodeActionsOnSave(language) {
      let result = languageSpecificSettings.get(language);
      if (result !== void 0) {
        return result;
      }
      const value = workspaceConfig.inspect(`[${language}]`);
      if (value === void 0) {
        return MigrationData.create(void 0);
      }
      ...
      result = MigrationData.create({ globalValue, workspaceFolderValue, workspaceValue });
  ...
  recordWorkingDirectories() {
    function record(elem) {
      if (elem.value === void 0 || !Array.isArray(elem.value)) {
        return;
      }
      for (let i = 0; i < elem.value.length; i++) {
        const item = elem.value[i];
        ...
        if (DirectoryItem.is(item) && item["!cwd"] !== void 0) {
          continue;
        }
      }
    }
  ...
  needsUpdate() {
    if (MigrationData.needsUpdate(this.autoFixOnSave) || MigrationData.needsUpdate(this.validate) || MigrationData.needsUpdate(this.codeActionOnSave) || MigrationData.needsUpdate(this.workingDirectories)) {
      return true;
    }
  ...
  async update() {
    async function _update(config, section, newValue, target) {
      if (!newValue.changed) {
        return;
      }
      await config.update(section, newValue.value, target);
    }
    async function _updateLanguageSetting(config, section, settings, newValue, target) {
      if (!newValue.changed) {
        return;
      }
      if (settings === void 0) {
        settings = /* @__PURE__ */ Object.create(null);
      }
      if (settings["editor.codeActionsOnSave"] === void 0) {
    ...
    try {
      await _update(this.editorConfig, "codeActionsOnSave", this.codeActionOnSave.global, import_coc3.ConfigurationTarget.Global);
      await _update(this.editorConfig, "codeActionsOnSave", this.codeActionOnSave.workspace, import_coc3.ConfigurationTarget.Workspace);
      await _update(this.editorConfig, "codeActionsOnSave", this.codeActionOnSave.workspaceFolder, import_coc3.ConfigurationTarget.WorkspaceFolder);
      await _update(this.eslintConfig, "autoFixOnSave", this.autoFixOnSave.global, import_coc3.ConfigurationTarget.Global);
      await _update(this.eslintConfig, "autoFixOnSave", this.autoFixOnSave.workspace, import_coc3.ConfigurationTarget.Workspace);
      await _update(this.eslintConfig, "autoFixOnSave", this.autoFixOnSave.workspaceFolder, import_coc3.ConfigurationTarget.WorkspaceFolder);
      await _update(this.eslintConfig, "validate", this.validate.global, import_coc3.ConfigurationTarget.Global);
      await _update(this.eslintConfig, "validate", this.validate.workspace, import_coc3.ConfigurationTarget.Workspace);
      await _update(this.eslintConfig, "validate", this.validate.workspaceFolder, import_coc3.ConfigurationTarget.WorkspaceFolder);
      await _update(this.eslintConfig, "workingDirectories", this.workingDirectories.global, import_coc3.ConfigurationTarget.Global);
      await _update(this.eslintConfig, "workingDirectories", this.workingDirectories.workspace, import_coc3.ConfigurationTarget.Workspace);
      await _update(this.eslintConfig, "workingDirectories", this.workingDirectories.workspaceFolder, import_coc3.ConfigurationTarget.WorkspaceFolder);
      for (const language of this.languageSpecificSettings.keys()) {
        ...
        if (MigrationData.needsUpdate(value)) {
          ...
          const current = this.workspaceConfig.inspect(section);
          await _updateLanguageSetting(this.workspaceConfig, section, current?.globalValue, value.global, import_coc3.ConfigurationTarget.Global);
          await _updateLanguageSetting(this.workspaceConfig, section, current?.workspaceValue, value.workspace, import_coc3.ConfigurationTarget.Workspace);
          await _updateLanguageSetting(this.workspaceConfig, section, current?.workspaceFolderValue, value.workspaceFolder, import_coc3.ConfigurationTarget.WorkspaceFolder);
        }
      }
    } finally {
      if (this.didChangeConfiguration) {
        this.didChangeConfiguration();
        this.didChangeConfiguration = void 0;
      }
    }
  }
};
...
((StatusNotification2) => {
  ...
  StatusNotification2.type = new import_coc4.NotificationType(StatusNotification2.method);
})(StatusNotification || (StatusNotification = {}));
var NoConfigRequest;
((NoConfigRequest2) => {
  NoConfigRequest2.method = "eslint/noConfig";
  NoConfigRequest2.type = new import_coc4.RequestType(NoConfigRequest2.method);
...
((NoESLintLibraryRequest2) => {
  ...
  NoESLintLibraryRequest2.type = new import_coc4.RequestType(NoESLintLibraryRequest2.method);
...
((OpenESLintDocRequest2) => {
  ...
  OpenESLintDocRequest2.type = new import_coc4.RequestType(OpenESLintDocRequest2.method);
})(OpenESLintDocRequest || (OpenESLintDocRequest = {}));
var ProbeFailedRequest;
((ProbeFailedRequest2) => {
  ProbeFailedRequest2.method = "eslint/probeFailed";
  ProbeFailedRequest2.type = new import_coc4.RequestType(ProbeFailedRequest2.method);
})(ProbeFailedRequest || (ProbeFailedRequest = {}));
var ShowOutputChannel;
((ShowOutputChannel2) => {
  ShowOutputChannel2.method = "eslint/showOutputChannel";
  ShowOutputChannel2.type = new import_coc4.NotificationType0("eslint/showOutputChannel");
})(ShowOutputChannel || (ShowOutputChannel = {}));
var ExitCalled;
((ExitCalled2) => {
  ExitCalled2.method = "eslint/exitCalled";
  ExitCalled2.type = new import_coc4.NotificationType(ExitCalled2.method);
...
async function pickFolder(folders, placeHolder) {
  ...
  const selected = await import_coc5.window.showQuickPick(
    folders.map((folder) => {
      return { label: folder.name, description: import_coc5.Uri.parse(folder.uri).fsPath, folder };
    }),
    { placeHolder }
  );
  if (selected === void 0) {
...
var Validator = class {
  ...
  check(textDocument) {
    const config = import_coc6.workspace.getConfiguration("eslint", import_coc6.Uri.parse(textDocument.uri));
    if (!config.get("enable", true)) {
      return "off" /* off */;
    }
    if (import_coc6.Uri.parse(textDocument.uri).scheme === "untitled" && config.get("ignoreUntitled", false)) {
      return "off" /* off */;
    }
    const languageId = textDocument.languageId;
    const validate = config.get("validate", null);
...
var ESLintClient;
((ESLintClient2) => {
  function migrationFailed(client2, error) {
    client2.error(error.message ?? "Unknown error", error);
    void import_coc6.window.showErrorMessage("ESLint settings migration failed. Please see the ESLint output channel for further details", "Open Channel").then((selected) => {
      if (selected === void 0) {
        return;
      }
  ...
  async function migrateSettings(client2) {
    const folders = import_coc6.workspace.workspaceFolders;
    if (folders === void 0) {
      void import_coc6.window.showErrorMessage("ESLint settings can only be converted if coc.nvim is opened on a workspace folder.");
      return;
    }
    ...
    const migration = new Migration(import_coc6.Uri.parse(folder.uri));
    migration.record();
    if (migration.needsUpdate()) {
      try {
        await migration.update();
      } catch (error) {
        migrationFailed(client2, error);
      }
    }
  }
  ESLintClient2.migrateSettings = migrateSettings;
  ...
  function create(context, validator2) {
    const alwaysShow = import_coc6.workspace.getConfiguration("eslint", null).inspect("alwaysShow").globalValue;
    const packageJsonFilter = { scheme: "file", pattern: "**/package.json" };
    const configFileFilter = { scheme: "file", pattern: "**/{.eslintr{c.js,c.yaml,c.yml,c,c.json},eslint.confi{g.js,g.mjs,g.cjs}}" };
    const supportedQuickFixKinds = /* @__PURE__ */ new Set([import_coc6.CodeActionKind.Source, import_coc6.CodeActionKind.SourceFixAll, `${import_coc6.CodeActionKind.SourceFixAll}.eslint`, import_coc6.CodeActionKind.QuickFix]);
    const syncedDocuments = /* @__PURE__ */ new Map();
    const client2 = new import_coc6.LanguageClient("ESLint", createServerOptions(import_coc6.Uri.parse(context.extensionPath)), createClientOptions());
    const defaultErrorHandler = client2.createDefaultErrorHandler();
    let serverCalledProcessExit = false;
    const migrationSemaphore = new Semaphore(1);
    let migration;
    let notNow = false;
    const languageStatus = import_coc6.window.createStatusBarItem();
    let serverRunning;
    ...
    context.subscriptions.push(import_coc6.workspace.onDidChangeConfiguration(() => {
      validator2.clear();
      for (const textDocument of syncedDocuments.values()) {
        if (validator2.check(textDocument) === "off" /* off */) {
          const provider = client2.getFeature(import_vscode_languageserver_protocol.DidCloseTextDocumentNotification.method).getProvider(textDocument);
          provider?.send(textDocument).catch((error) => client2.error(`Sending close notification failed.`, error));
        }
      }
      for (const textDocument of import_coc6.workspace.textDocuments) {
        if (!syncedDocuments.has(textDocument.uri.toString()) && validator2.check(textDocument) !== "off" /* off */) {
          const provider = client2.getFeature(import_vscode_languageserver_protocol.DidOpenTextDocumentNotification.method).getProvider(textDocument);
          provider?.send(textDocument).catch((error) => client2.error(`Sending open notification failed.`, error));
        }
      }
    }));
    client2.onNotification(ShowOutputChannel.type, () => {
      client2.outputChannel.show();
    });
    client2.onNotification(StatusNotification.type, (params) => {
      updateDocumentStatus(params);
    });
    client2.onNotification(ExitCalled.type, (params) => {
      serverCalledProcessExit = true;
      client2.error(`Server process exited with code ${params[0]}. This usually indicates a misconfigured ESLint setup.`, params[1]);
      void import_coc6.window.showErrorMessage(`ESLint server shut down itself. See 'ESLint' output channel for details.`, { title: "Open Output", id: 1 }).then((value) => {
        if (value !== void 0 && value.id === 1) {
          client2.outputChannel.show();
        }
      });
    });
    client2.onRequest(NoConfigRequest.type, (params) => {
      const document = import_coc6.Uri.parse(params.document.uri);
      const workspaceFolder = import_coc6.workspace.getWorkspaceFolder(document);
    ...
    client2.onRequest(NoESLintLibraryRequest.type, async (params) => {
      const key = "noESLintMessageShown";
      const state = context.globalState.get(key, {});
      const uri = import_coc6.Uri.parse(params.source.uri);
      ...
      if (workspaceFolder) {
        ...
        if (!state.workspaces[workspaceFolder.uri.toString()]) {
          ...
          void import_coc6.window.showInformationMessage(`Failed to load the ESLint library for the document ${uri.fsPath}. See the output for more information.`, outputItem).then((item) => {
            if (item && item.id === 1) {
    ...
    client2.onRequest(OpenESLintDocRequest.type, async (params) => {
      await import_coc6.commands.executeCommand("vscode.open", import_coc6.Uri.parse(params.url));
      return {};
    });
    client2.onRequest(ProbeFailedRequest.type, (params) => {
      const uri = import_coc6.Uri.parse(params.textDocument.uri);
      validator2.add(uri);
      const closeFeature = client2.getFeature(import_vscode_languageserver_protocol.DidCloseTextDocumentNotification.method);
      const diagnosticsFeature = client2.getFeature(import_vscode_languageserver_protocol.DocumentDiagnosticRequest.method);
      for (const document of import_coc6.workspace.textDocuments) {
    ...
    client2.onDidChangeState((event) => {
      if (event.newState === import_coc6.State.Starting) {
        client2.info(starting);
        serverRunning = void 0;
      } else if (event.newState === import_coc6.State.Running) {
    ...
    context.subscriptions.push(
      import_coc6.window.onDidChangeActiveTextEditor(() => {
        updateStatusBar(void 0);
      }),
      import_coc6.workspace.onDidCloseTextDocument((document) => {
        const uri = document.uri.toString();
        documentStatus.delete(uri);
        updateLanguageStatusSelector();
        updateStatusBar(void 0);
      }),
      import_coc6.commands.registerCommand("eslint.executeAutofix", async () => {
        ...
        await client2.start();
        client2.sendRequest(import_vscode_languageserver_protocol.ExecuteCommandRequest.method, params).then(void 0, () => {
          void import_coc6.window.showErrorMessage("Failed to apply ESLint fixes to the document. Please consider opening an issue with steps to reproduce.");
        });
      })
    );
    return [client2, acknowledgePerformanceStatus];
    function createServerOptions(extensionUri) {
      const serverModule = import_path4.default.join(extensionUri.fsPath, "lib/server.js");
      const eslintConfig = import_coc6.workspace.getConfiguration("eslint");
      ...
      const result = {
        run: { module: serverModule, transport: import_coc6.TransportKind.ipc, runtime, options: { execArgv, cwd: process.cwd(), env } },
        debug: { module: serverModule, transport: import_coc6.TransportKind.ipc, runtime, options: { execArgv: execArgv !== void 0 ? execArgv.concat(debugArgv) : debugArgv, cwd: process.cwd(), env } }
      };
      return result;
    }
    ...
    function createClientOptions() {
      const clientOptions = {
        ...
        revealOutputChannelOn: import_coc6.RevealOutputChannelOn.Never,
        initializationOptions: {},
        progressOnInitialization: true,
        synchronize: {
          fileEvents: [
            import_coc6.workspace.createFileSystemWatcher("**/.eslintr{c.js,c.cjs,c.yaml,c.yml,c,c.json}"),
            import_coc6.workspace.createFileSystemWatcher("**/eslint.config.js"),
            import_coc6.workspace.createFileSystemWatcher("**/.eslintignore"),
            import_coc6.workspace.createFileSystemWatcher("**/package.json")
          ]
        },
        ...
        errorHandler: {
          ...
          closed: () => {
            if (serverCalledProcessExit) {
              return import_coc6.CloseAction.DoNotRestart;
            }
        ...
        diagnosticPullOptions: {
          ...
          filter: (document, mode) => {
            const config = import_coc6.workspace.getConfiguration("eslint", document);
            const run = config.get("run", "onType");
            if (mode === "onType" /* onType */ && run !== "onType") {
              return true;
            } else if (mode === "onSave" /* onSave */ && run !== "onSave") {
              return true;
            }
            return validator2.check(document) === "off" /* off */;
          }
          //onTabs: false
        },
        middleware: {
          didOpen: async (document, next) => {
            if (import_coc6.workspace.match([packageJsonFilter], document) || import_coc6.workspace.match([configFileFilter], document) || validator2.check(document) !== "off" /* off */) {
          ...
          provideCodeActions: async (document, range, context2, token, next) => {
            ...
            const only = Array.isArray(context2.only) ? context2.only[0] : void 0;
          ...
          workspace: {
            ...
            didChangeConfiguration: async (sections, next) => {
              if (migration !== void 0 && (sections === void 0 || sections.length === 0)) {
    ...
    async function getPackageManager(uri) {
      const userProvidedPackageManager = import_coc6.workspace.getConfiguration("eslint", uri).get("packageManager", "npm");
      const detectedPackageManager = await import_coc6.commands.executeCommand("npm.packageManager");
      if (userProvidedPackageManager === detectedPackageManager) {
        return detectedPackageManager;
      }
      client2.warn(`Detected package manager(${detectedPackageManager}) differs from the one in the deprecated packageManager setting(${userProvidedPackageManager}). We will honor this setting until it is removed.`, {});
    ...
    async function readConfiguration(params) {
      ...
      for (const item of params.items) {
        ...
        const resource = import_coc6.Uri.parse(item.scopeUri);
        const textDocument = getTextDocument(resource);
        const config = import_coc6.workspace.getConfiguration("eslint", textDocument ?? resource);
        const workspaceFolder = resource.scheme === "untitled" ? import_coc6.workspace.workspaceFolders !== void 0 ? import_coc6.workspace.workspaceFolders[0] : void 0 : import_coc6.workspace.getWorkspaceFolder(resource);
        await migrationSemaphore.lock(async () => {
          const globalMigration = import_coc6.workspace.getConfiguration("eslint").get("migration.2_x", "on");
          if (notNow === false && globalMigration === "on") {
            try {
              ...
              if (migration.needsUpdate()) {
                ...
                const file = import_path4.default.basename(resource.fsPath);
                const selected = await import_coc6.window.showInformationMessage(
                  [
                    `The ESLint 'autoFixOnSave' setting needs to be migrated to the new 'editor.codeActionsOnSave' setting`,
                    folder !== void 0 ? `for the workspace folder: ${folder}.` : `for the file: ${file}.`,
                ...
                if (selected !== void 0) {
                  if (selected.id === "yes") {
                    ...
                    await config.update("migration.2_x", "off", import_coc6.ConfigurationTarget.Global);
                  } else if (selected.id === "readme") {
                    notNow = true;
                    void import_coc6.workspace.openResource("https://github.com/microsoft/vscode-eslint#settings-migration");
                  }
                }
              }
            } finally {
        ...
        const useFlatConfig = config.get("useFlatConfig", null);
        const settings = {
          validate: "off" /* off */,
          packageManager: config.get("packageManager", "npm"),
          useESLintClass: config.get("useESLintClass", false),
          useFlatConfig: useFlatConfig === null ? void 0 : useFlatConfig,
          experimental: {
        ...
        if (Array.isArray(workingDirectories)) {
          ...
          let uri = import_coc6.Uri.parse(workspaceFolder.uri);
          const workspaceFolderPath = workspaceFolder && uri.scheme === "file" ? uri.fsPath : void 0;
          for (const entry of workingDirectories) {
            ...
            if (directory !== void 0 || pattern !== void 0) {
              let uri2 = import_coc6.Uri.parse(document.uri);
              const filePath = uri2.scheme === "file" ? uri2.fsPath : void 0;
              if (filePath !== void 0) {
                if (directory !== void 0) {
                  directory = toOSPath(directory);
                  if (!import_path4.default.isAbsolute(directory) && workspaceFolderPath !== void 0) {
                    directory = import_path4.default.join(workspaceFolderPath, directory);
                  }
                  if (directory.charAt(directory.length - 1) !== import_path4.default.sep) {
                    directory = directory + import_path4.default.sep;
                  }
                  if (filePath.startsWith(directory)) {
                    itemValue = directory;
                  }
                } else if (pattern !== void 0 && pattern.length > 0) {
                  if (!import_path4.default.posix.isAbsolute(pattern) && workspaceFolderPath !== void 0) {
                    pattern = import_path4.default.posix.join(toPosixPath(workspaceFolderPath), pattern);
                  }
                  if (pattern.charAt(pattern.length - 1) !== import_path4.default.posix.sep) {
                    pattern = pattern + import_path4.default.posix.sep;
                  }
    ...
    function updateLanguageStatusSelector() {
      const selector = [];
      for (const key of documentStatus.keys()) {
        const uri = import_coc6.Uri.parse(key);
    ...
    function acknowledgePerformanceStatus() {
      const activeTextDocument = import_coc6.window.activeTextEditor?.document;
    ...
    function updateStatusBar(textDocument) {
      const activeTextDocument = textDocument ?? import_coc6.window.activeTextEditor?.document;
      if (activeTextDocument === void 0 || serverRunning === false) {
        languageStatus.hide();
        return;
      }
      const performanceInfo = performanceStatus.get(activeTextDocument.languageId);
      const statusInfo = documentStatus.get(activeTextDocument.uri.toString()) ?? { state: 1 /* ok */ };
      let validationBudget = import_coc6.workspace.getConfiguration("eslint", activeTextDocument).get("timeBudget.onValidation", { warn: 4e3, error: 8e3 });
      ...
      let fixesBudget = import_coc6.workspace.getConfiguration("eslint", activeTextDocument).get("timeBudget.onFixes", { warn: 3e3, error: 6e3 });
      ...
      let severity = 0 /* Information */;
      const [timeTaken, detail, message, timeBudget] = function() {
        if (performanceInfo === void 0 || performanceInfo.firstReport || performanceInfo.acknowledged) {
          return [-1, void 0, "", { warn: 0, error: 0 }];
        }
        if (performanceInfo.fixTime > performanceInfo.validationTime) {
          const timeTaken2 = Math.max(performanceInfo.fixTime, performanceInfo.reported);
          return [
            timeTaken2,
            timeTaken2 > fixesBudget.warn ? `Computing fixes took ${timeTaken2}ms` : void 0,
            `Computing fixes during save for file ${activeTextDocument.uri.toString()} during save took ${timeTaken2}ms. Please check the ESLint rules for performance issues.`,
            fixesBudget
          ];
        } else if (performanceInfo.validationTime > 0) {
          const timeTaken2 = Math.max(performanceInfo.validationTime, performanceInfo.reported);
          return [
            timeTaken2,
            timeTaken2 > validationBudget.warn ? `Validation took ${timeTaken2}ms` : void 0,
            `Linting file ${activeTextDocument.uri.toString()} took ${timeTaken2}ms. Please check the ESLint rules for performance issues.`,
            validationBudget
          ];
        }
        return [-1, void 0, "", { warn: 0, error: 0 }];
      ...
      if (severity === 0 /* Information */ && timeTaken > timeBudget.warn) {
        severity = 1 /* Warning */;
      }
      if (severity === 1 /* Warning */ && timeTaken > timeBudget.error) {
        severity = 2 /* Error */;
      }
      if (timeTaken > timeBudget.warn && performanceInfo !== void 0) {
        if (timeTaken > performanceInfo.reported) {
          if (timeTaken > timeBudget.error) {
            client2.error(message);
          } else {
            client2.warn(message);
          }
        }
      }
      if (performanceInfo !== void 0) {
      ...
      languageStatus.text = serverRunning === void 0 ? starting : text;
      if (alwaysShow || statusInfo.state !== 1 /* ok */) {
        languageStatus.show();
      } else {
        languageStatus.hide();
      }
...
function createDefaultConfiguration() {
  const folders = import_coc7.workspace.workspaceFolders;
  if (!folders) {
    void import_coc7.window.showErrorMessage("An ESLint configuration can only be generated if VS Code is opened on a workspace folder.");
    return;
  }
  const noConfigFolders = folders.filter((folder) => {
    ...
    for (const configFile of configFiles) {
      if (import_fs3.default.existsSync(import_path5.default.join(import_coc7.Uri.parse(folder.uri).fsPath, configFile))) {
        return false;
      }
    }
    return true;
  ...
  if (noConfigFolders.length === 0) {
    if (folders.length === 1) {
      void import_coc7.window.showInformationMessage("The workspace already contains an ESLint configuration file.");
    } else {
      void import_coc7.window.showInformationMessage("All workspace folders already contain an ESLint configuration file.");
    }
    return;
  }
  void pickFolder(noConfigFolders, "Select a workspace folder to generate a ESLint configuration for").then(async (folder) => {
    ...
    const folderRootPath = import_coc7.Uri.parse(folder.uri).fsPath;
    const terminal = await import_coc7.window.createTerminal({
      name: `ESLint init`,
      cwd: folderRootPath
    });
    const eslintCommand = await findEslint2(folderRootPath);
...
function activate(context) {
  ...
  function configurationChanged() {
    ...
    for (const textDocument of import_coc7.workspace.textDocuments) {
      if (validator.check(textDocument) !== "off" /* off */) {
        openListener.dispose();
        configurationListener.dispose();
        activated = true;
  ...
  let activated = false;
  const openListener = import_coc7.workspace.onDidOpenTextDocument(didOpenTextDocument);
  const configurationListener = import_coc7.workspace.onDidChangeConfiguration(configurationChanged);
  const notValidating = () => {
    const enabled = import_coc7.workspace.getConfiguration("eslint", import_coc7.window.activeTextEditor?.document).get("enable", true);
    if (!enabled) {
      void import_coc7.window.showInformationMessage(`ESLint is not running because the deprecated setting 'eslint.enable' is set to false. Remove the setting and use the extension disablement feature.`);
    } else {
      void import_coc7.window.showInformationMessage("ESLint is not running. By default only TypeScript and JavaScript files are validated. If you want to validate other file types please specify them in the 'eslint.probe' setting.");
    }
  };
  onActivateCommands = [
    import_coc7.commands.registerCommand("eslint.executeAutofix", notValidating),
    import_coc7.commands.registerCommand("eslint.showOutputChannel", notValidating),
    import_coc7.commands.registerCommand("eslint.migrateSettings", notValidating),
    import_coc7.commands.registerCommand("eslint.restart", notValidating),
    import_coc7.commands.registerCommand("eslint.revalidate", notValidating)
  ];
  context.subscriptions.push(
    import_coc7.commands.registerCommand("eslint.createConfig", createDefaultConfiguration)
  );
...
function realActivate(context) {
  ...
  context.subscriptions.push(
    import_coc7.commands.registerCommand("eslint.showOutputChannel", async () => {
      client.outputChannel.show();
      acknowledgePerformanceStatus();
    }),
    import_coc7.commands.registerCommand("eslint.migrateSettings", () => {
      void ESLintClient.migrateSettings(client);
    }),
    import_coc7.commands.registerCommand("eslint.restart", () => {
      client.restart().catch((error) => client.error(`Restarting client failed`, error, "force"));
    }),
    import_coc7.commands.registerCommand("eslint.revalidate", () => {
